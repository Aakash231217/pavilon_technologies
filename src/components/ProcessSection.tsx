  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-32 bg-[#0a0a0f] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Header */}
        <div className="process-title text-center mb-16 md:mb-24">
              ...
              return (
                ...
                >
                  ...
                  <div className={`${isLeft ? 'lg:order-2 lg:pl-20' : 'lg:pr-20'}`}>
                    <div className={`relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/[0.08] hover:bg-white/[0.04] transition-all duration-500 group`}>
                      {/* Gradient overlay */}
        ...
        <div className="mt-24 text-center">
          <div className="w-full sm:w-auto inline-flex flex-col sm:flex-row items-stretch sm:items-center gap-6 p-5 sm:p-8 bg-white/[0.02] border border-white/[0.08] rounded-3xl">
            ...
            <a
              href="#contact"
              data-cursor-hover
              className="w-full sm:w-auto px-8 py-4 bg-white text-black rounded-full font-medium hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 hover:text-white transition-all duration-500 whitespace-nowrap text-center"
            >
              Get Started
            </a>
          </div>
